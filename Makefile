...
update:
	-@env GIT_TERMINAL_PROMPT=0 sh -c '[ -d .git ] && git reset --hard -q && git pull -q || (curl -sL "https://github.com/rbm78bln/kmod_s5divert/archive/refs/heads/main.zip" | bsdtar --extract --strip-components=1 --verbose --file -)'
